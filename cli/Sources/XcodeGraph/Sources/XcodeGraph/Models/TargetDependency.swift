...
public enum TargetDependency: Equatable, Hashable, Codable, Sendable {
    ...
    case package(product: String, type: PackageType, package: String? = nil, condition: PlatformCondition? = nil)
    ...
    public var condition: PlatformCondition? {
        ...
        case .library(path: _, publicHeaders: _, swiftModuleMap: _, condition: let condition):
            condition
        case .package(product: _, type: _, package: _, condition: let condition):
            condition
    ...
    public func withCondition(_ condition: PlatformCondition?) -> TargetDependency {
        ...
        case .package(product: let product, type: let type, package: let package, condition: _):
            return .package(product: product, type: type, package: package, condition: condition)
